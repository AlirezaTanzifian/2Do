  ...
  <div class="group hover:bg-purple-300 transition flex justify-between p-3 border-2 border-solid border-purple-400 rounded-xl">
    <div class="flex items-center gap-4">
      <span
          ...
          @click="isDone=!isDone"
      >
        <i class="fa fa-check hover:text-xl transition" aria-hidden="true" :class="[isDone ? 'text-green-600' : 'text-gray-300']"></i>
      </span>
      <span class="text-base font-medium text-gray-700">do Home work</span>
    </div>
    <div class="hidden items-center gap-4 px-2 group-hover:flex group-hover:flex-row">
      ...
      <i class="fa fa-trash text-[20px] cursor-pointer hover:text-red-500" aria-hidden="true"></i>
    </div>
  </div>
</template>
